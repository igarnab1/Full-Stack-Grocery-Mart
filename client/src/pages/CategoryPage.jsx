  ...
  return (
    <section className=''>
      <div className='p-2   bg-white shadow-md flex items-center justify-between'>
        ...
        <button onClick={() => setOpenUploadCategory(true)} className='text-sm border border-secondary-light hover:bg-primary-light px-3 py-1 rounded'>Add Category</button>
      </div>
