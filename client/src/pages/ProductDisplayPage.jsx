        ...
        <section className='container mx-auto p-4 grid lg:grid-cols-2 '>
            <div>
                ...
                <div className='grid relative'>
                    <div ref={imageContainer} className='flex gap-4 z-10 relative w-full overflow-x-auto scrollbar-hide scroll-smooth'>
                        {
                            data.image.map((img, index) => {
                                return (
                ...
                <div className='my-4  hidden lg:grid gap-3 text-justify'>
                    <div>
            ...
            <div className='p-4 lg:pl-7 text-base lg:text-lg'>
                ...
                <h2 className='w-fit text-lg font-semibold lg:text-3xl'>{data.name}</h2>
                <p className='w-fit'>{data.unit}</p>
                <Divider />
                <div>
                    <div className='flex flex-col items-start gap-2'>
                        ...
                        <div className='flex items-center gap-2 lg:gap-4'>
                            ...
                            {
                                data.discount && (
                                    <p className="flex py-2 font-bold text-green-600 lg:text-2xl">{data.discount}% <span className='text-base lg:py-1 text-neutral-500'>Discount</span></p>
                                )
                            }
...

                {
                    data.stock === 0 ? (
                        ...
                        <div className='flex flex-col items-start w-fit my-4'>
                ...
                <h2 className='w-fit font-semibold'>Why shop from binkeyit? </h2>
                ...
                {/****only mobile */}
                <div className='lg:hidden my-4 grid gap-3 text-justify'>
                    <div>
                        <p className='font-semibold'>Description</p>
                        <p className='text-base'>{data.description}</p>
                    </div>
