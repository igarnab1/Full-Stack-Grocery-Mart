    ...
    <section>
      ...
      <div className='p-4 bg-blue-50'>
        ...
        <div className='flex justify-between my-4'>
          <button onClick={handlePrevious} className="border border-primary-light px-4 py-1 hover:bg-primary-200">Previous</button>
          <button className='w-full bg-slate-100'>{page}/{totalPageCount}</button>
          <button onClick={handleNext} className="border border-primary-light px-4 py-1 hover:bg-primary-200">Next</button>
        </div>
